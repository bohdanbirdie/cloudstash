...
| -------------------------------- | ----------------------- | --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| D1                               | Worker control plane    | users, OAuth accounts, sessions, organizations, members, API keys, invites, app settings, billing, aggregate activity | most control rows cascade; activity rows currently survive deletion                                                                                     |
...
| Workflow storage                 | Cloudflare Workflows    | deletion payload/status/step history with user/workspace IDs                                                          | retained instance; lifecycle not documented                                                                                                             |
...
| Stripe                           | external billing owner  | customer, subscription, invoice/payment records                                                                       | account deletion currently does not cancel remote service ([DELTA-019](../../.delta/DELTA-019-deletion-target-failures-and-surfaces-are-incomplete.md)) |
