...
export function buildAgentSpec(origin: string): string {
  return [
    "# Cloudstash API",
    "",
    "This is the HTTP API specification for Cloudstash. Use it to list, search, save, read, and update links in your library. Link reprocessing remains an admin-only action in the Cloudstash app.",
    "",
    ...
    "Plan: the Public API is available on Plus and Pro. Free workspaces receive 402.",
