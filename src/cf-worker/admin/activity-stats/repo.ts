...
export class ActivityStatsRepo
  extends /* TODO(effect-v4-codemod): manual migration required for effect-service-manual */ Effect.Service<ActivityStatsRepo>()(
    "@cloudstash/ActivityStatsRepo",
    {
      effect: Effect.gen(function* () {
        ...
        return {
          ...
          savesBySource: Effect.fn("ActivityStatsRepo.savesBySource")(
