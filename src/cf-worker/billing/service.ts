...
export class Billing
  extends /* TODO(effect-v4-codemod): manual migration required for effect-service-manual */ Effect.Service<Billing>()(
    "@cloudstash/Billing",
    {
      effect: Effect.gen(function* () {
        ...
        return {
          ...
          capabilities: Effect.fn("Billing.capabilities")(function* (
            orgId: OrgId
          ) {
          ...
          subscription: Effect.fn("Billing.subscription")(function* (
            orgId: OrgId
          ) {
          ...
          getOverrides: Effect.fn("Billing.getOverrides")(function* (
            orgId: OrgId
          ) {
            const row = yield* fetchOrgRow(orgId);
          ...
          >(orgId: OrgId, key: K, value: TierCapabilities[K] | null) {
            const existing = yield* fetchOrgRow(orgId);
            const current: CapabilityOverrides =
