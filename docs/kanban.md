...
- [ ] [[todos/e2e-do-sync-testing|E2E testing for DO-to-DO sync]] — note (2026-08-09): upstream now carries the hibernation + reconstruction guard suites (#1427/#1435/#1541), so scope this at cloudstash app-level flows (ingest → sync → UI), not livestore internals.
